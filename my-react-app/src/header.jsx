...
export default function Header() {
  ...
  return (
    <div className='border-b border-[#283440] bg-[#18212a] pl-5 pb-2 pt-1 flex items-center'>
        <div  className=' flex text-center items-center rounded-3xl mt-1 py-1 bg-[#4a3f20] w-[20%]'>
            <div className='ml-3'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="#f1aa05" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#f1aa05" className="size-7 ">
        ...
        <div className='bg-[#037EFB] ml-auto px-3 py-2 flex mt-1 items-center rounded-3xl font-medium'>
            <div>
            ...
            <p className='ml-2'>0.00 TON</p>
        </div>

        <div className='bg-[#232D39] ml-4 w-10 h-10 mt-1 justify-center  rounded-full outline outline-2 items-center flex outline-gray-600 mr-5'>
