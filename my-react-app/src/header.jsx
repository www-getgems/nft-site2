...
export default function Header() {
  ...
  return (
    <div className='border-b border-[#283440] bg-[#18212a] pl-5 pb-1 flex items-center font-bold'>
        ...
        <div className='bg-[#037EFB] ml-auto px-2 py-1 flex mt-1 items-center rounded-3xl font-bold'>
            <div>
        ...
        <div className='bg-[#232D39] ml-4 w-8 h-8 mt-1 justify-center  rounded-full outline outline-2 items-center flex outline-gray-600 mr-5'>
